...
@Autonomous
class AutoAlbastruBARIERE : BBLinearOpMode() {
    ...
    override fun runOpMode() {
        ...
        val startPose = Pose2d(14.0, 65.5, Math.toRadians(180.0))
        ...
        val trajSeq: TrajectorySequence = drive.trajectorySequenceBuilder(startPose)
            ...
            .waitSeconds(2.0)
            .lineToLinearHeading(Pose2d(-19.0, index_rata_y, Math.toRadians(180.0)))
            .addTemporalMarker {
